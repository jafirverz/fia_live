...
class NewUserPaymentReminder extends Command
{
     ...
     * @var string
     */
    protected $signature = 'newuserpaymentreminder:users';
     ...
     * @var string
     */
    protected $description = 'Send reminder for payment for new user';
