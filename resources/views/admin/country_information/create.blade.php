                        ...
                        <div class="col-md-12">
                            <div class="form-group{{ $errors->has('country_id') ? ' has-error' : '' }}">
                                ...
                                <select name="country_id" id="country-id" class="checkViewOrder form-control select2" style="width: 100%;" >
                                    ...
                                    <option value="{{ $country->id }}" @if(old('country_id')) @if($country->id==old('country_id')) selected @endif @endif>{{ $country->tag_name }}</option>
                                    @endforeach
                                    @endif
                                </select>
...
<script>
    $('.checkViewOrder').change(function() {
        ...
        $.ajax({
            ...
            method:"POST",
            dataType:"JSON",
            data:{ _token: CSRF_TOKEN,information_filter_id:informationFilterId,country_id:countryId},
