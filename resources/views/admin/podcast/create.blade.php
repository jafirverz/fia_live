        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="box box-primary">
                    <!-- form start -->
                    <form name="podcast" method="post" action="{{ url('/admin/podcast/store')}}"
                        ...
                        <div class="box-body">
                            <div class="form-group{{ $errors->has('topical_id') ? ' has-error' : '' }}">
                                ...
                                <select name="topical_id[]" class="form-control select2" style="width: 100%;" multiple>
                                    ...
                                    <option value="{{ $topic->id }}" @if(old('topical_id')) @if(in_array($topic->id,
                                        old('topical_id'))) selected @endif @endif>{{ $topic->tag_name }}</option>
                                    @endforeach
                                    @endif
                                </select>
