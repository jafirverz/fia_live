        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="box box-primary">
                    ...
                    <form name="payment" method="post" action="{{ url('/admin/payment/store')}}">
...
<input class="form-control datepicker" placeholder="" value="{{ old('payment_date') }}" name="payment_date" type="text" id="payment_date">                            
                        </div>
                        
                        <div class="form-group">
<label for="payment_date" class=" control-label">Subscription Date</label>
<input class="form-control datepicker" placeholder="" value="{{ old('subscription_date') }}" name="subscription_date" type="text" id="subscription_date">                            
                        </div>
...
<input class="form-control datepicker" placeholder="" value="{{ old('renewal_date') }}" name="renewal_date" type="text" id="renewal_date">                            
                        </div>
