...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        {{ Breadcrumbs::render('edit_role', $admin->id) }}
    </section>
    <!-- Main content -->
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="form-group @if($errors->first('name')) has-error @endif">
                            ...
                            <input class="form-control" name="name" placeholder="Enter name" type="text" value="{{  $admin->name ?? '' }}">
                            <span class="help-block">@if($errors->first('name')) {{ $errors->first('name') }} @endif</span>
                        </div>
