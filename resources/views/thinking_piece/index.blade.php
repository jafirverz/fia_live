...
@section('content')
      <div class="main-wrap">   
                ...
                <form name="filter" method="get" action="{{ url('/thinking-piece/search')}}" enctype="multipart/form-data">
						...
						<div class="grid-1 item">
							<div class="tb-col">
								<div class="col date-col">
									<span class="month">{{date("F",strtotime($thinkingPiece->thinking_piece_date))}}</span> <strong>{{date("d",strtotime($thinkingPiece->thinking_piece_date))}}</strong> {{date("Y",strtotime($thinkingPiece->thinking_piece_date))}}
								</div>
