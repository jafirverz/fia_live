...
<div class="main-wrap">
    ...
    <div class="map-wrap">
        ...
        <div id="map_country_detail">
            ...
            @endphp
            <div id="singapore" class="pin-pp openpp">
                <div class="tb-col">
                    <div class="col">
                        <div class="content">
                            <a href="#new" class="fas fa-times">Close</a>
                            <h2>singapore</h2>
                            <a class="fas fa-angle-double-right link"
                                href="{{url('search-results-regulatory?country=singapore')}}"><span class="ico"><img
                                        src="{{url(asset('images/tempt/ico-5.png'))}}" alt=""></span> Regulatory
                                Updates</a>
                            @if($category=='#')
                            <a style="background:#CCC;" class="fas fa-angle-double-right link"><span class="ico"><img
                                        src="{{url(asset('tempt/ico-6.png'))}}" alt=""></span> Country Information</a>
                            @else
                            <a class="fas fa-angle-double-right link"
                                href="{{url('country-information-details?country=Singapore&category='.$category)}}"><span
                                    class="ico"><img src="{{url(asset('images/tempt/ico-6.png'))}}" alt=""></span>
        ...
        <div class="row">
            ...
            <div class="col-sm-7">
                <div class="grid-2 slick-1 eheight">
                    ...
                    if( $regulatory) {
                    if($i<=3) { @endphp <div class="item">
                        <div class="box-4">
                            <figure><img src="{{getFilterCountryImage($regulatory->country_id)}}"
                                    alt="{{getFilterCountry($regulatory->country_id)}} flag" /></figure>
                            <div class="content">
                                <div class="ecol">
                                    <h3 class="title">{{$regulatory->title}}</h3>
                                    <p class="date"><span
                                            class="country">{{getFilterCountry($regulatory->country_id)}}</span> |
                                        {{ $regulatory->created_at->format('M d, Y') }}</p>
                                    {!!
                                    Illuminate\Support\Str::limit(strip_tags(getRegulatoryDescription($regulatory->id)),
                                    150) !!}
                                </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-7">
            <div class="grid-2 slick-1 eheight">
                ...
                @endphp
                <div class="item">
                    <div class="box-4" style="padding-top: 15px;padding-bottom: 15px;">
                    
                        <div class="content">
                            <div class="ecol fea-rsc">
                                <h2 class="title-0">Topical Report</h3>
                                <h3 class="title">{{ucfirst($topical->title)}}</h3>
                ...
                <div class="item">
                    <div class="box-4" style="padding-top: 15px;padding-bottom: 15px;">
                        <div class="content">
                            <div class="ecol fea-rsc">
                                <h2 class="title-0">Podcast</h2>
                                <h3 class="title">{{ ucfirst($podcast->title) }}</h3>
                    ...
                    <div class="box-4" style="padding-top: 15px;padding-bottom: 15px;">
                        <div class="content">
                            <div class="ecol fea-rsc">
                                ...
                                <h2 class="title-0">Thinking Piece</h2>
                                <h3 class="title">{{ ucfirst($thinkingPiece->thinking_piece_title) }}</h3>
...
<div class="intro-home-2 tb-col break-720">
    ...
    $video='<video controls="">
        <source src="'.$page->video1.'" type="video/mp4"></video>';
    ...
    @php
    $video='<video controls="">
        <source src="'.$page->video2.'" type="video/mp4"></video>';
    echo $other_contents2=str_replace("{{VIDEO_HOME}}",$video,$page->other_contents2);
...
<div class="intro-home-3">
    <div class="container">
        ...
        <div class="intro">
            ...
            <a class="btn-2" href="{{ url('register')}}">REGISTER NOW!</a>
        </div>
        @endif
    </div>
</div>
