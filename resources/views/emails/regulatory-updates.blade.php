    ...
    <tr>
        <td align="center"
            ...
            <table class="content inner-body" width="100%" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; line-height: 0 !important; text-align: center; padding: 10px;">
