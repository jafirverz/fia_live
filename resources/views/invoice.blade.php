...
<head>
    ...
    <style type="text/css">
        ...
        .tb-1 tbody td {
            ...
            border-left: #f48120 solid 2px;
        }

        .tb-1 tbody td:last-child {
            border-right: #f48120 solid 2px;
            border-left: none;
        }

        .tb-1 tbody tr:last-child td:last-child {
            border-radius: 0 0 10px 0;
        }

        .tb-1 tbody tr:last-child td:first-child {
        ...
        .tb-1 tfoot tr:first-child td {
            padding-top: 40px;
        }

        .tb-1 tfoot td:first-child, .tb-1 tfoot td:last-child {
            text-align: right;
        }
...
<div class="invoice-wrap">
        ...
        <div class="col-1">
            @if($data['organization'])
                <div class="gr-1 clearfix">
                    <div class="lb">Bill To:</div>
                    <div class="gr"></div>
                </div>
                <div class="gr-3 clearfix">
                    <div class="lb"><strong>Company:</strong></div>
                    <div class="gr">{{$data['organization']}}</div>
                </div>
                <div class="gr-3 clearfix">
                    <div class="lb">Address:</div>
                    <div class="gr">{{$data['address1'].' '.$data['address2']}}</div>
                </div>
            @endif
        </div>
        <div class="col-2">
    ...
    <div class="gr-3 clearfix">
        <div class="lb"><strong>Attention:</strong></div>
        <div class="gr"></div>
    </div>

    <div class="gr-3 clearfix">
        <div class="lb">Name:</div>
        <div class="gr">{{$data['firstname'].' '.$data['lastname']}}</div>
    </div>
